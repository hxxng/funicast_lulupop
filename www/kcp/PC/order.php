...
?>
                    <tr>
                        ...
                        <td>
							...
							<input type="hidden" name="pay_method" id="pay_method" value="<?=$_POST[pay_method]?>" />
                        </td>
                    </tr>
                    <!-- 주문번호(ordr_idxx) -->
                    <tr>
                    ...
                    <tr>
                        <th>상품명</th>
                        <td><input type="text" name="good_name" class="w100" value="<?=$_POST[good_name]?>"/></td>
                    </tr>
                    <!-- 결제금액(good_mny) - ※ 필수 : 값 설정시 ,(콤마)를 제외한 숫자만 입력하여 주십시오. -->
                    <tr>
                        <th>결제 금액</th>
                        <td><input type="text" name="good_mny" class="w100" value="<?=$_POST[good_mny]?>"/>원(숫자만 입력)</td>
                    </tr>
                    <!-- 주문자명(buyr_name) -->
                    <tr>
                        <th>주문자명</th>
                        <td><input type="text" name="buyr_name" class="w100" value="<?=$_POST[buyr_name]?>"/></td>
                    </tr>
