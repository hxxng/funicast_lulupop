				...
				<div class="card-body">
                    ...
                    <form method="get" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>" onsubmit="return frm_search_chk(this);">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    <label for="sel_search_date" class="col-sm-2 col-form-label">지급일</label>
                                    <div class="col-sm-4">
                                        <div class="input-group">
                            ...
                            <li class="list-group-item">
                                <div class="form-group row align-items-center mb-0">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <input type="button" class="btn btn-secondary ml-2" value="초기화" onclick="location.href='./coin_distribution_list.php'" />
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <?
                        ...
                        $where_query .= " ct_type = 2 and mt_id is not null";
					...
					<tr>
						...
						<td class="text-center">
							<?=number_format($row['ct_amount'])?>코인
						</td>
                        <td class="text-center">
                            <?=$row['mt_nickname']?>
                        </td>
