			<!-- 하단 시작 -->
			<footer class="footer">
				<div class="d-sm-flex justify-content-center justify-content-sm-between"> <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?=date("Y")?> <?=APP_TITLE?>. All rights reserved.</span>
					<span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">DMONSTER <i class="mdi mdi-bullseye-arrow text-danger"></i></span>
				</div>
			</footer>
			<!-- 하단 끝 -->
		</div>
