                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> 공지사항</h4>
                            <form class="form-inline">
                                <div class="form-group mx-sm-1">
                                    <input type="button" class="btn btn-primary" value="공지사항 등록" onclick="location.href='./notice_form.php?act=input'">
                                </div>
                            </form>
                                    ...
                                    <li class="list-group-item">
                                        <div class="form-group row align-items-center mb-0">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <input type="button" class="btn btn-secondary ml-2" value="초기화" onclick="location.href='./notice_list.php'" />
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            if($_GET['search_txt']) {
                                $where_query .= $_where."(instr(a1.nt_title, '".$_GET['search_txt']."') or instr(nt_content, '".$_GET['search_txt']."'))";
                                $_where = " and ";
                            }
                            if($_GET['sel_search_sdate'] && $_GET['sel_search_edate']) {
                                $where_query .= $_where." nt_wdate between '".$_GET['sel_search_sdate']." 00:00:00' and '".$_GET['sel_search_edate']." 23:59:59'";
                                $_where = " and ";
                            }
                            ...
                            if($list) {
                                foreach($list as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?=DateType($row['nt_wdate'],8)?>
                                        </td>
                                        <td class="text-center">
                                            <input type="button" class="btn btn-outline-secondary btn-sm" value="상세보기" onclick="location.href='./notice_form.php?act=update&nt_idx=<?=$row['nt_idx']?>&<?=$_get_txt.$_GET['pg']?>'" />
                                        </td>
                                    </tr>
                                <?
                                        $counts--;
