                ...
                <div class="card">
                                ...
                                <li class="list-group-item">
                                    <div class="form-group row align-items-center mb-0">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <input type="button" class="btn btn-secondary ml-2" value="초기화" onclick="location.href='./refund_list.php'" />
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    -->
                        <table class="table table-striped table-hover">
                            ...
                            $_where = " and ";
                            $query = "
                                select a1.*, ot_pcode, ct_status, ct_request_wdate from order_t a1 left join cart_t on cart_t.ot_code = a1.ot_code where ct_status in (90,91)
                            ";
                            if($_GET['search_txt']) {
...
//								$pt_info = get_product_t_info($row['pt_idx']);
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <input type="button" class="btn btn-outline-secondary btn-sm" value="자세히" onclick="location.href='./refund_form.php?act=view_order&ot_pcode=<?=$row['ot_pcode']?>&<?=$_get_txt.$_GET['pg']?>'" />
                                        </td>
                                    </tr>
                                    <?
                                    $counts--;
